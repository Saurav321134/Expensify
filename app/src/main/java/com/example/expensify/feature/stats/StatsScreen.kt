...
import com.example.expensify.feature.home.TransactionList
...
fun LineChart(entries: List<Entry>) {
    ...
    AndroidView(
        ...
        val dataSet = LineDataSet(entries, "Expenses").apply {
            color = android.graphics.Color.parseColor("#5394FA")
            ...
            valueTextSize = 12f
            valueTextColor = android.graphics.Color.parseColor("#5394FA")
